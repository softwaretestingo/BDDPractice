...
public class SD03_CucumberExpressionParameterTypesStep 
{
	...
	public void ft03_user_is_on_the_login_page() 
	{
		System.out.println("User is on the login page");
	}
	@When("FT03_User Enter {int}, {double}, {string}, \\{}  Details")
	public void ft03_user_enter_details(Integer int1, Double double1, String string) 
	{
	...
	public void ft03_user_profile_page_will_be_display() 
	{
		 System.out.println("User Profile Page Will Be Display");
	}
	@Then("FT03_User Details Will Be Display")
	public void ft03_user_details_will_be_display() 
	{
